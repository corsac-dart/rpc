...
import 'middleware/api_action_invoker_test.dart' as api_action_invoker;
import 'middleware/api_action_resolver_test.dart' as api_action_resolver;
...
void main() {
  ...
  pipeline.main();
  test_utils.main();
  api_action_invoker.main();
  api_action_resolver.main();
  prefix.main();
  router.main();
  version.main();
}
